...
<body>
    <header>
        <nav style="display:flex; gap:10px; align-items:center;"><a href="{{ route('home') }}">Accueil</a><a
                href="{{ route('about') }}">À propos</a><a href="{{ route('products.index') }}">Nos Produits</a>@auth
                <span>Bonjour {{ auth()->user()->name }} !</span><a href="{{ route('profile') }}">Mon profil</a>
    ...
    <footer>&copy;
        {{ date('Y') }} ShopLaravel - Tous droits réservés </footer>
</body>
